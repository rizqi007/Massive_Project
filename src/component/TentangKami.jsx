        ...
        <div>
            ...
            <div className="rounded-md mt-12">
                <div className="flex flex-row justify-center pb-6 ">
                    <div>
                        <img
                            className="sm:w-10 md:w-20 lg:w-60"
                            src={Foto1}
                            alt="Gambar1"
                        />
                        <h3 className="text-center text-black font-semibold mt-2">
                            Tykea
                        </h3>
                    </div>
                    <div>
                        <img
                            className="sm:w-10 md:w-20  lg:w-60 mx-8"
                            src={Foto2}
                            alt="Gambar1"
                        />
                        <h3 className="text-center text-black font-semibold mt-2">
                ...
                <div className="flex flex-row justify-center pb-12">
                    ...
                    <div>
                        <img
                            className="sm:w-10 md:w-20  lg:w-60 mr-8"
                            src={Foto6}
                            alt="Gambar1"
                        />
                        <h3 className="text-center text-black font-semibold mt-2">
